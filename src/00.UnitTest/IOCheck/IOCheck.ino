...
#define SERVO1_MAX_LIMIT  SERVO1_MAX-25
#define SERVO2_MAX_LIMIT  SERVO2_MAX+25
...
void LiftUp_LIMIT()
{
  ...
  for ( int i = 0; i <= STEP; i++) {
    int angle1 = map(i, 0, STEP, SERVO1_MIN, SERVO1_MAX_LIMIT);
    int angle2 = map(i, 0, STEP, SERVO2_MIN, SERVO2_MAX_LIMIT);
    _servo1.write(angle1);
    _servo2.write(angle2);
    delay(20);
  }
